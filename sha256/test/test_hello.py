...
# - Run quietly:
# -- [all tests] pytest3 --quiet edgecase_article/test
# -- pytest3 --quiet edgecase_article/test/test_hello.py
# - Print log output in real-time during a single test:
# -- pytest3 --capture=no --log-cli-level=INFO edgecase_article/test/test_hello.py::test_hello
